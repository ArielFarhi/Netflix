  ...
  return (
    <div className="max-w-screen min-h-screen bg-[#141414] text-white overflow-x-hidden relative">
      ...
      <div className="relative z-10 px-3 sm:px-10 lg:px-20 space-y-12 pt-5">
        <MatchedForYouRow title="Matched To You" setSelectedMovie={setSelectedMovie} />
        <NewReleasesRow title="New on Netflix" setSelectedMovie={setSelectedMovie} />
        <TopViewsRow title="Top 10 movies in the U.S. Today" setSelectedMovie={setSelectedMovie} />
        <RecentlyReviewedRow title="Recently Reviewed" setSelectedMovie={setSelectedMovie} />
        <SuggestedForYouRow title="Suggested For You" setSelectedMovie={setSelectedMovie} />
        <AnimatedRow title="Animated Favorites" setSelectedMovie={setSelectedMovie} />
        <TrendingRow title="Documentaries" genreId={99} setSelectedMovie={setSelectedMovie} />
        <MyListRow
